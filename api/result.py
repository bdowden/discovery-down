...
class Result:
    def __init__(self, added: Optional[datetime] = None, posted: Optional[datetime] = None, id: Optional[int] = 0, grabs:Optional[int] = 0, size:Optional[int] = 0, season:Optional[int] = 0, episode: Optional[int] = 0, title: Optional[str] = "", tvdbid: Optional[str] = "", resolution: Optional[int] = 0):
